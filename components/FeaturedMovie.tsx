    ...
    <Animated.View style={styles.container} entering={FadeIn.duration(800)}>
      ...
      <View style={styles.content}>
        ...
        <Animated.View style={styles.metaContainer} entering={FadeInDown.delay(400).duration(600)}>
          ...
          <Text style={styles.year}>{movie.release_date ? new Date(movie.release_date).getFullYear() : movie.first_air_date ? new Date(movie.first_air_date).getFullYear() : "N/A"}</Text>
        </Animated.View>
